...
public class ContextConfig {
    ...
    private String moduleName = "spark";  //模块名称

    private String proPackage = "cn.stylefeng.guns.admin";
    private String coreBasePackage = "cn.stylefeng.guns.core";
    private String modelPackageName = "cn.stylefeng.guns.modular.spark.model";        //model的包名
    private String modelMapperPackageName = "cn.stylefeng.guns.modular.spark.dao";    //model的dao
    ...
    public void init() {
        ...
        modelPackageName = proPackage + "." + "modular.spark.model";
        modelMapperPackageName = proPackage + "." + "modular.spark.dao";
    }
