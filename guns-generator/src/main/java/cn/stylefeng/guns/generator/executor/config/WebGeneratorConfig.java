...
public class WebGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void config() {
        ...
        packageConfig.setEntity(genQo.getProjectPackage() + ".modular.spark.model");
        packageConfig.setMapper(genQo.getProjectPackage() + ".modular.spark.dao");
        packageConfig.setXml(genQo.getProjectPackage() + ".modular.spark.dao.mapping");
